...
[+] Debian based users need to install signify-openbsd. In Linux mint you may need to set software sources in update manager to default to install signify-openbsd
#
